...
public class Model_DTPF extends BaseModelStructure {
    ...
    public Model_DTPF() {
        charToBlock.put('C', new BlockInfo(Blocks.brick_block, 0));
        charToBlock.put('N', new BlockInfo(Blocks.dirt, 0));
        charToBlock.put('b', new BlockInfo(Blocks.emerald_block, 0));
        charToBlock.put('s', new BlockInfo(Blocks.lapis_block, 0));
